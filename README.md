...
- **消费行为**：月消费101-500元占**75.5%**，约70%有冲动购买倾向。
- **决策因素**：独特设计（3.97/5）> 面料质感 > 价格合理 > 限量/绝版 > 设计师知名度（最低）。
- **社群参与**：90%使用娃友社群（QQ/微信），60%每周及以上参与互动。
...
3. 运行问卷分析： `完整分析链路.ipynb`:在网页打开：https://nbviewer.org/github/qjn0116/zheng_da_bei/blob/main/python/%E5%AE%8C%E6%95%B4%E5%88%86%E6%9E%90%E9%93%BE%E8%B7%AF.ipynb 或者打开完整分析链路.pdf.
4. 或直接查看已生成的图表和结论。
